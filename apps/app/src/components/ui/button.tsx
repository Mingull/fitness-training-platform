		...
		variants: {
			variant: {
				...
				destructive: cn(
					...
					Platform.select({
						web: "hover:bg-destructive/20 focus-visible:border-destructive/40 focus-visible:ring-destructive/20 dark:hover:bg-destructivedark:focus-visible:ring-destructive/40",
					}),
				),
