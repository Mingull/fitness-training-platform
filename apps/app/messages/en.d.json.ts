	...
	trainingPrograms: {
		...
		states: {
			empty: {
				...
				description: "You do not have any training programs yet. If a trainer assigned a program it will appear here; otherwise create your first program to get started.";
				refresh: "Refresh";
			};
			error: {
